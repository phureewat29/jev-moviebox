/** Lucide carries no brand marks, so GitHub and X are drawn here at the icon size. */
const GithubMark = () => (
...
const iconButton =
  "flex size-8 items-center justify-center rounded-full text-ink-faint transition-colors hover:bg-screen-raised hover:text-ink";

const divider = (
  <span className="mx-1 text-edge" aria-hidden>
    |
  </span>
);
